    ...
    while videoDevice.isOpened():
        ...
        if detection_result_available == True:
            ...
            if len(detection_result.face_landmarks) > 0:
                ...
                try:
                    z = detection_result.face_landmarks[0][33].x - detection_result.face_landmarks[0][263].x  #offset

                    dataPoints = f"""{detection_result.face_landmarks[0][33].x}, 
                                     {detection_result.face_landmarks[0][33].y},
                                     {detection_result.face_landmarks[0][33].z + z},
                                     
                                     {detection_result.face_landmarks[0][263].x},
                                     {detection_result.face_landmarks[0][263].y}, 
                                     {detection_result.face_landmarks[0][263].z + z},
                                     
                                     {detection_result.face_landmarks[0][61].x}, 
                                     {detection_result.face_landmarks[0][61].y},
                                     {detection_result.face_landmarks[0][61].z + z}, 
                                     
                                     {detection_result.face_landmarks[0][291].x},
                                     {detection_result.face_landmarks[0][291].y}, 
                                     {detection_result.face_landmarks[0][291].z + z}"""
